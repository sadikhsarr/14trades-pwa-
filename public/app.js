...
async function showMissedSignalsScreen() {
  ...
  overlay.innerHTML = `
    <div style="max-width:420px;margin:0 auto;padding:32px 20px 100px">
      ...
      <div style="margin-bottom:24px">
        <div style="font-size:22px;font-weight:800;color:#F0F2F8;line-height:1.3;margin-bottom:8px">Ton accès a expiré.</div>
        <div style="font-size:13px;color:#444;line-height:1.7">Pendant ton absence, Sadikh a continué à analyser Gold chaque jour. Voici ce que tu as manqué :</div>
      </div>

      <!-- Missed signals — loaded from server -->
      ...
      <!-- Total missed -->
      <div id="missed-total" style="display:none;background:#0D0C00;border:1px solid #C9A84C20;border-radius:12px;padding:14px 16px;margin-bottom:24px;text-align:center">
        <div style="font-size:10px;color:#C9A84C;letter-spacing:1px;margin-bottom:4px">TU AS MANQUÉ</div>
        <div id="missed-pips" style="font-family:monospace;font-size:36px;font-weight:900;color:#C9A84C;line-height:1">—</div>
        <div style="font-size:10px;color:#C9A84C;opacity:.5;margin-top:2px">pips depuis ton départ</div>
      </div>
  ...
  try {
    ...
    const totalEl = document.getElementById('missed-total');
    ...
    if (signals.length > 0) {
      ...
      list.innerHTML = signals.slice(0,4).map(s => {
