...
function checkAccess() {
  // Just logged in — flag set within last 10 seconds → boot directly
  const justLoggedIn = localStorage.getItem('14t_just_logged_in');
  if (justLoggedIn && (Date.now() - parseInt(justLoggedIn)) < 10000) {
