...
function showRenewalModal() {
  ...
  modal.innerHTML = `
    <div style="width:100%;max-width:440px;background:#0D0D0D;border-radius:20px 20px 0 0;border-top:1px solid #1A1A1A;padding:24px 20px 40px">
      ...
      <div style="font-family:monospace;font-size:32px;font-weight:700;color:#C9A84C;text-align:center;margin-bottom:6px">15 000 CFA</div>
  ...
  const PAYMENT_INFO = {
    wave: {
      ...
      instructions: [
        ...
        'Envoie 15 000 CFA au numéro:',
        '+221 78 825 50 99 (Sadikh)',
        'Note: "Renouvellement ' + code + '"'
      ],
      action: 'Ouvrir Wave',
      link: 'https://wa.me/221788255099?text=' + encodeURIComponent('Bonjour Sadikh, je viens de payer 15 000 CFA via Wave pour renouveler mon accès 30 jours. Mon code: ' + code)
    },
    orange: {
      title: '🟠 Orange Money',
      color: '#FF6B00',
      ...
      link: 'https://wa.me/221788255099?text=' + encodeURIComponent('Bonjour Sadikh, je viens de payer 15 000 CFA via Orange Money pour renouveler mon accès 30 jours. Mon code: ' + code)
    },
    crypto: {
      title: '₿ Crypto',
      color: '#F7931A',
