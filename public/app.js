...
document.addEventListener('DOMContentLoaded', async () => {
  checkAccess();
  // Safety fallback — if nothing shows after 500ms, show public screen
  setTimeout(function() {
    var main = document.getElementById('main-app');
    var pub  = document.getElementById('public-screen');
    var exp  = document.getElementById('expired-screen');
    // If everything is hidden — show public screen
