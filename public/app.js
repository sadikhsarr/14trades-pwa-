...
async function showMissedSignalsScreen() {
  ...
  overlay.innerHTML = `
    <div style="max-width:420px;margin:0 auto;padding:32px 20px 100px">
      ...
      <!-- Real stats — win rate + missed pips together -->
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:14px">
        <div style="background:#0D0D0D;border:1px solid #C9A84C25;border-radius:12px;padding:14px;text-align:center">
          <div style="font-size:8px;color:#555;letter-spacing:1px;margin-bottom:4px">TAUX RÉEL</div>
          <div id="missed-winrate" style="font-family:monospace;font-size:24px;font-weight:800;color:#C9A84C">—</div>
        </div>
        <div style="background:#0D0D0D;border:1px solid #00C87A25;border-radius:12px;padding:14px;text-align:center">
          <div style="font-size:8px;color:#555;letter-spacing:1px;margin-bottom:4px">DEPUIS TON DÉPART</div>
          <div id="missed-pips" style="font-family:monospace;font-size:24px;font-weight:800;color:#00C87A">—</div>
        </div>
      </div>
      ...
      <!-- CTA -->
      <div style="background:#0D0D0D;border:1px solid #1A1A1A;border-radius:16px;padding:20px;margin-bottom:16px">
        <div style="font-family:monospace;font-size:28px;font-weight:700;color:#C9A84C;text-align:center;margin-bottom:4px">57 000 CFA</div>
        <div style="font-size:10px;color:#333;text-align:center;margin-bottom:16px">/ 30 jours · Signaux illimités</div>
        <div style="display:flex;flex-direction:column;gap:8px">
          ...
          <button onclick="selectPaymentMissed('crypto')" style="display:flex;align-items:center;gap:12px;background:#0A1A0A;border:1px solid #F7931A25;border-radius:10px;padding:12px 14px;cursor:pointer;font-family:inherit;width:100%">
            <span style="font-size:18px">₿</span>
            <div style="text-align:left"><div style="font-size:12px;font-weight:700;color:#F0F2F8">Crypto — automatique</div><div style="font-size:9px;color:#555">100 USDT · accès immédiat</div></div>
            <div style="margin-left:auto;font-size:11px;color:#F7931A">→</div>
          </button>
        </div>
      </div>
