...
const CACHE   = '14trades-v116';
const ASSETS  = ['/', '/index.html', '/app.js', '/style.css', '/manifest.json', '/trial.html', '/road-to-1m.html'];
...
self.addEventListener('fetch', e => {
  ...
  if (url.pathname === '/performance.html' || url.pathname === '/trial.html' || url.pathname === '/road-to-1m.html') {
